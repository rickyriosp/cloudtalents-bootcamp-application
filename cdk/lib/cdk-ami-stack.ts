...
export class CloudTalentsAmiStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    // Security Group
    // ----------------------------------------------------------------------
    const ec2SecurityGroup = new ec2.SecurityGroup(this, 'ec2-ssh-sg', {
      vpc: vpc,
    ...
    // EC2 Role
    // ----------------------------------------------------------------------
    const ec2Role = new iam.Role(this, 'ec2-ami-role', {
      roleName: 'ec2-ami-role',
    ...
    // ----------------------------------------------------------------------
    const ec2InstanceProfile = new iam.InstanceProfile(this, 'ec2-ami-iprofile', {
      instanceProfileName: 'ec2-ami-iprofile',
      role: ec2Role,
    });
